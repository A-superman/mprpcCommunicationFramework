...
extern ResgisterResponseDefaultTypeInternal _ResgisterResponse_default_instance_;
class ResultCode;
...
template<> ::fixbug::ResgisterResponse* Arena::CreateMaybeMessage<::fixbug::ResgisterResponse>(Arena*);
...
class ResgisterResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.ResgisterResponse) */ {
 public:
  ResgisterResponse();
  virtual ~ResgisterResponse();

  ResgisterResponse(const ResgisterResponse& from);
  ResgisterResponse(ResgisterResponse&& from) noexcept
    : ResgisterResponse() {
    *this = ::std::move(from);
  }

  inline ResgisterResponse& operator=(const ResgisterResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline ResgisterResponse& operator=(ResgisterResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ResgisterResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ResgisterResponse* internal_default_instance() {
    return reinterpret_cast<const ResgisterResponse*>(
               &_ResgisterResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(ResgisterResponse& a, ResgisterResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(ResgisterResponse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline ResgisterResponse* New() const final {
    return CreateMaybeMessage<ResgisterResponse>(nullptr);
  }

  ResgisterResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ResgisterResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ResgisterResponse& from);
  void MergeFrom(const ResgisterResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ResgisterResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.ResgisterResponse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.ResgisterResponse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool ResgisterResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool ResgisterResponse::has_result() const {
  return _internal_has_result();
}
inline void ResgisterResponse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& ResgisterResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& ResgisterResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.ResgisterResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* ResgisterResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.ResgisterResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* ResgisterResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* ResgisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResgisterResponse.result)
  return _internal_mutable_result();
}
inline void ResgisterResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResgisterResponse.result)
}

// bool sucess = 2;
inline void ResgisterResponse::clear_sucess() {
  sucess_ = false;
}
inline bool ResgisterResponse::_internal_sucess() const {
  return sucess_;
}
inline bool ResgisterResponse::sucess() const {
  // @@protoc_insertion_point(field_get:fixbug.ResgisterResponse.sucess)
  return _internal_sucess();
}
inline void ResgisterResponse::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void ResgisterResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:fixbug.ResgisterResponse.sucess)
}
