...
class ResgisterResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ResgisterResponse> _instance;
} _ResgisterResponse_default_instance_;
}  // namespace fixbug
...
static void InitDefaultsscc_info_ResgisterResponse_user_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_ResgisterResponse_default_instance_;
    new (ptr) ::fixbug::ResgisterResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::ResgisterResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ResgisterResponse_user_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ResgisterResponse_user_2eproto}, {
      &scc_info_ResultCode_user_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::ResgisterResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::ResgisterResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ResgisterResponse, sucess_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 29, -1, sizeof(::fixbug::ResgisterResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_ResgisterResponse_default_instance_),
};
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "G\n\021ResgisterResponse\022\"\n\006result\030\001 \001(\0132\022.f"
  "ixbug.ResultCode\022\016\n\006sucess\030\002 \001(\0102\206\001\n\016Use"
  "rServiceRpc\0224\n\005Login\022\024.fixbug.LoginReque"
  "st\032\025.fixbug.LoginResponse\022>\n\010Register\022\027."
  "fixbug.RegisterRequest\032\031.fixbug.Resgiste"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_user_2eproto_sccs[5] = {
  ...
  &scc_info_ResgisterResponse_user_2eproto.base,
  &scc_info_ResultCode_user_2eproto.base,
};
...
void ResgisterResponse::InitAsDefaultInstance() {
  ::fixbug::_ResgisterResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class ResgisterResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const ResgisterResponse* msg);
};

const ::fixbug::ResultCode&
ResgisterResponse::_Internal::result(const ResgisterResponse* msg) {
  return *msg->result_;
}
ResgisterResponse::ResgisterResponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.ResgisterResponse)
}
ResgisterResponse::ResgisterResponse(const ResgisterResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  if (from._internal_has_result()) {
  ...
  sucess_ = from.sucess_;
  // @@protoc_insertion_point(copy_constructor:fixbug.ResgisterResponse)
}

void ResgisterResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResgisterResponse_user_2eproto.base);
  ::memset(&result_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&sucess_) -
      reinterpret_cast<char*>(&result_)) + sizeof(sucess_));
}
...
ResgisterResponse::~ResgisterResponse() {
  // @@protoc_insertion_point(destructor:fixbug.ResgisterResponse)
  SharedDtor();
}

void ResgisterResponse::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void ResgisterResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ResgisterResponse& ResgisterResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ResgisterResponse_user_2eproto.base);
  return *internal_default_instance();
}


void ResgisterResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.ResgisterResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ResgisterResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* ResgisterResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.ResgisterResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.ResgisterResponse)
  return target;
}

size_t ResgisterResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.ResgisterResponse)
  size_t total_size = 0;
...
void ResgisterResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.ResgisterResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const ResgisterResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ResgisterResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.ResgisterResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.ResgisterResponse)
    MergeFrom(*source);
  }
}

void ResgisterResponse::MergeFrom(const ResgisterResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.ResgisterResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void ResgisterResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.ResgisterResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ResgisterResponse::CopyFrom(const ResgisterResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.ResgisterResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ResgisterResponse::IsInitialized() const {
  return true;
}

void ResgisterResponse::InternalSwap(ResgisterResponse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(result_, other->result_);
  swap(sucess_, other->sucess_);
...
::PROTOBUF_NAMESPACE_ID::Metadata ResgisterResponse::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 1:
      Register(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::RegisterRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::ResgisterResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::ResgisterResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::ResgisterResponse* Arena::CreateMaybeMessage< ::fixbug::ResgisterResponse >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::ResgisterResponse >(arena);
}
